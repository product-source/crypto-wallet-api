import { AdminSignupDto, AdminUpdateProfileDto, ChangePasswordDto, PlatformFeeDto, ResetPasswordDto, verifyMailDto, CreateAdminDto, UpdateAdminRoleDto, AdminListQueryDto, UpdateFiatWalletDto } from "./dto/admin.dto";
...
export declare class AdminController {
    ...
    updateFiatWallet(dto: UpdateFiatWalletDto, req: any): Promise<import("@nestjs/common").NotFoundException | {
        message: string;
        data: {
            FiatEvmAdminWallet: string;
            FiatTronAdminWallet: string;
