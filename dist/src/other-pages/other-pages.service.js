...
exports.OtherPagesService = void 0;
...
let OtherPagesService = class OtherPagesService {
    constructor(otherPageModel) {
    ...
    async ensureDefaultOtherPageExist() {
        ...
        if (otherPageCount === 0) {
            ...
            console.log("Default otherPage inserted successfully.......................");
        }
    }
    async addPage(dto) {
        try {
...
exports.OtherPagesService = OtherPagesService;
exports.OtherPagesService = OtherPagesService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_2.InjectModel)(other_pages_schema_1.OtherPage.name)),
    __metadata("design:paramtypes", [mongoose_1.Model])
], OtherPagesService);
//# sourceMappingURL=other-pages.service.js.map