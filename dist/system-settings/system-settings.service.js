...
let SystemSettingsService = class SystemSettingsService {
    ...
    async set(key, value, description) {
        return this.settingModel.findOneAndUpdate({ key }, { value, description }, { upsert: true, new: true });
    }
    async getAll() {
...
exports.SystemSettingsService = SystemSettingsService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(system_setting_schema_1.SystemSetting.name)),
